// Main application component - defines routes and global layout
...
function App() {
  return (
    <Router>
      <div className="min-h-screen flex flex-col transition-all duration-500 bg-gradient-to-br from-black via-gray-900 to-violet-900 text-white">
        <nav className="bg-black/80 text-white px-6 py-3 flex justify-between items-center shadow-lg border-b border-violet-700">
          ...
          <div className="flex items-center space-x-6 font-medium">
            ...
            <Link to="/routes" className="hover:text-violet-400">
              Routes
            </Link>
