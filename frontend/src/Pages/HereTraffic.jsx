    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="text-lg text-gray-600">Loading HERE Maps traffic data...</div>
          <div className="text-sm text-gray-400 mt-2">Fetching live incidents and traffic flow...</div>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">HERE Maps Live Traffic</h1>
              <p className="text-gray-600 mt-1">Real-time traffic incidents and conditions for Nashville, TN</p>
            </div>
            <button 
          ...
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-start">
              <div className="flex-1">
                <h3 className="text-red-800 font-semibold">Error Loading Traffic Data</h3>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-4 bg-gray-50 border-b border-gray-200">
                <h2 className="text-lg font-semibold text-gray-900">Live Traffic Map</h2>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Route Planner</h2>
              ...
              {routeResult && (
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <h3 className="font-semibold text-green-900 mb-2">Route Found</h3>
